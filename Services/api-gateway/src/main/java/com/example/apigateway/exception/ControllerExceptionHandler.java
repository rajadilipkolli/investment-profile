...
public class ControllerExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<GatewayError> handleRestControllerException(
    ...
    private ResponseEntity<GatewayError> handleUnexpectedException(
            RestControllerException e, WebRequest request) {
    ...
    private ResponseEntity<GatewayError> errorResponse(
            RestControllerException e, HttpHeaders headers) {
        return new ResponseEntity<>(
                new GatewayError(e.getHttpStatus().value(), e.getMessage()),
                headers,
                e.getHttpStatus());
    }
