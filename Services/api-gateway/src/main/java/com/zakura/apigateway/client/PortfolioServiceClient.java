...
public interface PortfolioServiceClient {
	...
	@CrossOrigin
	@Valid Investment updateUserInvestment(@RequestBody @Valid Investment investmentToUpdate,
										   @PathVariable("userId") String userId);

	@PostMapping("/portfolio-service/investments/delete/{userId}")
	@CrossOrigin
	@Valid String deleteUserInvestment(@RequestBody @Valid Investment investmentToDelete,
									   @PathVariable("userId") String userId);
}
