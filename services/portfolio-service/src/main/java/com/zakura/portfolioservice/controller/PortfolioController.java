...
public class PortfolioController {
    ...
    public List<Investment> getProfitInvestments(@PathVariable("userId") String userId) {
        ArrayList<Investment> investments =
                portfolioRepository.findByUserName(userId).orElse(new ArrayList<>());
    ...
    public @Valid Investment addUserInvestment(
            @RequestBody @Valid Investment investmentToSave,
            @PathVariable("userId") String userId) {
        Investment investment =
                portfolioRepository
                        .findByUserNameAndNameAndType(
                                userId, investmentToSave.getName(), investmentToSave.getType())
        ...
        if (null != investment.getName()) {
            ...
            portfolioRepository.deleteByUserNameAndNameAndType(
                    userId, investment.getName(), investment.getType());
    ...
    public @Valid Investment updateUserInvestment(
        ...
        Investment investment =
                portfolioRepository
                        .findByUserNameAndNameAndType(
                                userId, investmentToUpdate.getName(), investmentToUpdate.getType())
                        .orElse(Investment.builder().build());
        if (null != investment.getName()) {
            portfolioRepository.deleteByUserNameAndNameAndType(
                    userId, investment.getName(), investment.getType());
    ...
    public @Valid String deleteUserInvestment(
            @RequestBody @Valid Investment investmentToUpdate,
            @PathVariable("userId") String userId) {
        Investment investment =
                portfolioRepository
