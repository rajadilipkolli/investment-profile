...
public class StockController {
    ...
    public String saveUserStock(
            @RequestBody @Valid StockRequest stockRequest, @PathVariable("userId") String userId) {
        Optional<Stock> stockBoughtOptional =
                stockService.findByNameAndInvestmentType(
                        stockRequest.name(), stockRequest.investmentType());
